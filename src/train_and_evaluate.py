...
def main():
    """
    Main function to execute training and evaluate.
    """
    parser = argparse.ArgumentParser(description="Run ML pipeline.")
    parser.add_argument("--processed_data_source", type=str, required=False, default= os.path.join("data\processed", "processed_raw_2025-05-19_20-58.csv"), help="processed data path")
    parser.add_argument("--model_name", type=str, required=False, default="linear_regression.pkl", help="Name of the model to save (e.g., linear_regression.pkl)")
    parser.add_argument("--test_size", type=float, default=0.2, help="Test set size (0.1 - 0.5)")

    args = parser.parse_args()

    processed_csv = args.processed_data_source
